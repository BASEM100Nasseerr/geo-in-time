...
public class po2_HomePage {
    ...
    private final  By gender = By.xpath("//span [@class=\"mat-select-placeholder mat-select-min-line ng-tns-c158-39 ng-star-inserted\"]");
    private final  By isnideGender = By.xpath("(//span [@class=\"mat-option-text\"])[1]");
    private final  By office = By.xpath("//span [@class=\"mat-select-placeholder mat-select-min-line ng-tns-c158-43 ng-star-inserted\"]");
